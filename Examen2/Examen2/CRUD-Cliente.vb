...
Public Class CrudClientes
    ...
    Private Sub btnCrear_Click(sender As Object, e As EventArgs) Handles btnCrear.Click
        If txtCodigo.Text = "" Or txtNombre.Text = "" Or txtApellido.Text = "" Or txtDireccion.Text = "" Then
        ...
        ElseIf IsNumeric(txtNombre.Text) Or IsNumeric(txtApellido.Text) Then
            MsgBox("Error al ingresar intentar ingresar los datos. Nombre y Apellido no deben ser datos numericos", vbExclamation)
        Else
            Try
